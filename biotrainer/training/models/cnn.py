...
from biotrainer_core.utils import constants as biotrainer_constants
...
class CNN(BiotrainerModel):
    ...
    def forward(self, x: torch.Tensor, *args, **kwargs) -> torch.Tensor:
        ...
        # Calculate mask
        mask = (x.sum(dim=-1) != biotrainer_constants.SEQUENCE_PAD_VALUE).unsqueeze(1).unsqueeze(3)  # Shape: (B, 1, L, 1)
